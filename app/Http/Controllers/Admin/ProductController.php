...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.produk.produk', ['type_menu' => '', 'products' => $products]);
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.produk.tambah-produk', ['type_menu' => '', 'categorys' => $category]);
    }
    ...
    public function show(Product $product)
    {
        //
        // return $product;
        return view('pages.admin.produk.detail-produk', ['type_menu' => '', 'product' => $product]);
    }
    public function show_api(Product $product)
    {
        //
        // return $product;
        return $product;
    ...
    {
        $category = $this->categoryProductModel->get();
        return view('pages.admin.produk.edit-produk', [
            'type_menu' => '',
            'product' => $product,
            'categorys' => $category
        ]);
    ...
    public function update(ProdukUpdateRequest $request, Product $product)
    {
        ...
        try {
            ...
            return redirect()->route('admin.produk.index')->with('success', "Data produk '{$product->name_product}' berhasil diubah");
        } catch (\Throwable $e) {
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.produk.index')->with('success', "Data produk '{$product->name_product}' berhasil dihapus");
    }
}
