...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.kategori_produk.kategori_produk', ['type_menu' => '', 'category_products' => $category_produk]);
    }

    public function create()
    {
        return view('pages.admin.kategori_produk.tambah_kategori_produk', ['type_menu' => '']);
    }
    ...
    {
        return view('pages.admin.kategori_produk.edit_kategori_produk', [
            'type_menu' => '',
            'category' => $category
        ]);
    }
