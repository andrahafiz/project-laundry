    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                @endif
                <form method="POST" action="{{ route('customer.user.update', $user->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="user-item">
                                        <img alt="image"
                                            src="{{ $user->photo == 'avatar.jpg' ? asset('img/avatar/avatar-4.png') : Helper::setUrlImage($user->photo) }}"
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3"
                                                role="tab" aria-controls="home" aria-selected="true">Data Pribadi</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#profile3"
                                                role="tab" aria-controls="profile" aria-selected="false">Data Akun</a>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-8">
                                                    <input type="text" class="form-control" name='password'
                                                        value="{{ old('password') }}">
                                                    <small class="text-muted">*Kosongkan jika tidak ingin ganti
                                                        password</small>
                                                </div>
                                            </div>
                                        </div>
