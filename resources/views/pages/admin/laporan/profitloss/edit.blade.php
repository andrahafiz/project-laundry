                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='modal_awal'
                                                value="{{ old('modal_awal') ?? $data->modal_awal }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='laba_bersih'
                                                value="{{ old('laba_bersih') ?? $data->laba_bersih }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Prive</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='prive'
                                                value="{{ old('prive') ?? $data->prive }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Penambahan
                                            Modal</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='penambahan_modal'
                                                value="{{ old('penambahan_modal') ?? $data->penambahan_modal }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Modal
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='modal_akhir'
                                                value="{{ old('modal_akhir') ?? $data->modal_akhir }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
