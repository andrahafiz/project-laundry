                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-body mt-4">
                                <form method="POST" action="{{ route('admin.laporan.modal.store') }}">
                                    @csrf
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="month" class="form-control" name='periode'
                                                value="{{ old('periode') }} max="{{ now()->format('Y-m') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Modal
                                            Awal</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='modal_awal' id="modal_awal"
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Laba
                                            Bersih</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='laba_bersih' id="laba_bersih"
                                                value="{{ old('laba_bersih') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Modal
                                            Akhir</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" class="form-control" name='modal_akhir' id="modal_akhir"
                                                value="{{ old('modal_akhir') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
